...
> the roadmap slices it blocks. **All D-rows are Open/unsigned — nothing in the
> proposed target architecture is ratified until its gate signs.** Decisions are
